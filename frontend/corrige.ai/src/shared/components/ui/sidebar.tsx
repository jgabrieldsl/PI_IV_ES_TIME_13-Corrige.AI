...
function Sidebar({
  ...
  return (
    <div
      ...
      data-slot="sidebar"
    >
      {/* Isso é o que lida com o espaço da barra lateral no desktop */}
      <div
      ...
      <div
        ...
        className={cn(
          ...
          // Ajusta o preenchimento para variantes flutuantes e inseridas.
          variant === 'floating' || variant === 'inset'
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        // Aumenta a área de toque do botão no celular.
